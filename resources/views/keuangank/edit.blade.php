...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800 text-center">{{ $title ?? __('Edit Data Keuangan Kantor') }}</h1>

<!-- Main Content goes here -->
<form action="/keuangank/update/{{ $keuangan->id }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="content">
        <div class="row">
            <div class="col-sm-6">
