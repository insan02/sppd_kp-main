...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800 text-center">{{ $title ?? __('Keuangan Pusat') }}</h1>
...
<table id="table" class="table table-bordered table-stripped">
    ...
    <tbody>
        ...
        @if($item->status_disposisi =='Terima' && $item->status_keuangan =='Pending')
        <tr>
            ...
            <td>
                <div class="d-flex">
                    <a href="/keuangan/show/{{ $item->id }}" class="btn  btn-info mr-2 btn-sm">Proses</a>
                </div>
        </tr>
        @elseif ($item->status_disposisi =='Terima' && $item->status_keuangan =='Terima')
        <tr>
        </tr>
        @endif
        @endforeach
